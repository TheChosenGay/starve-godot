...
public sealed class ActionPresentationControllerTests
{
    ...
    public void SameKindAuthorityConfirmsPredictionWithoutRestart()
    {
        ...
        controller.Predict(7, ActionKind.Attack);
        controller.Apply(7, State(11, ActionKind.Attack, ActionPhase.Windup));

        Assert.Equal(
            new ActionPresentationStatus(false, ActionKind.Attack, 11, ActionPhase.Windup),
    ...
    public void PredictionExpiresWithoutAuthority()
    {
        ...
        var sink = new RecordingSink();
        var controller = new ActionPresentationController(sink, () => now);
        controller.Predict(7, ActionKind.Chop);
    ...
    public void MovementCancelsPrediction()
    {
        ...
        controller.Predict(7, ActionKind.Mine);
    ...
    public void NewActionIdRestartsAnimation()
    {
        ...
        Assert.Equal(
            new ActionPresentationStatus(false, ActionKind.Attack, 21, ActionPhase.Windup),
            controller.StatusOf(7));
    }
    ...
    private static ActionState State(ulong id, ActionKind kind, ActionPhase phase) => new()
    {
        ActionId = id,
        Kind = kind,
        Phase = phase,
    ...
    private static ActionOutcome Outcome(ulong id, ActionOutcomeResult result) => new()
    {
        EntityId = 7,
        ActionId = id,
        RequestId = 13,
